// Multiplayer functionality for Bee Day Game

// Mock player data (in a real app, this would come from a server)
const mockPlayers = [
  { id: "player1", name: "BusyBee", color: 0xFFD700, position: { x: 20, y: 15, z: 10 }, honeyCollected: 750 },
  { id: "player2", name: "HoneyHunter", color: 0xFFA500, position: { x: -15, y: 12, z: -5 }, honeyCollected: 600 },
  { id: "player3", name: "PollenPro", color: 0x00FF00, position: { x: 5, y: 18, z: 20 }, honeyCollected: 890 }
];

// Player representation objects in THREE.js
